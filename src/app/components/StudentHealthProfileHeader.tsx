...
export function StudentHealthProfileHeader() {
  return (
    <nav className="fixed top-0 left-60 right-0 bg-white px-6 py-4 flex items-center justify-between z-20 shadow-sm">
      <h1 className="text-3xl font-bold text-blue-950">Students Health Profile</h1>
