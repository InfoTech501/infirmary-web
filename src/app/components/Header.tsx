  ...
  return (
    <header className="fixed top-0 left-60 right-0 bg-white px-6 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        <a href='/notification' className="relative bg-yellow-100 p-2 rounded-xl hover:bg-yellow-200">
          <Bell />
        </a>

        <a href='/account' className="flex items-center gap-2 hover:bg-gray-200 rounded-full px-2 py-1">
